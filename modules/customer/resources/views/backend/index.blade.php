...
@section('breadcrumb')
    <a class="breadcrumb-item active" href="{{ route('customer.index') }}">{{ $display_name }}</a>
...
@section('content')
    <div class="br-section-wrapper">
        ...
        <div class="col-sm-2 col-md-2 pd-0 mg-b-20">
            {{--@if (Entrust::can['customer-create'])--}}
            @permission('customer-create')
                <button class="btn btn-info btn-block" onclick="window.location='{{ route('customer.create') }}'">
        ...
        <div class="rounded table-responsive">
            <table class="table table-bordered mg-b-0" id="customer_table">
                <thead>
                <tr>
                    <th class="wd-5p">@lang('global.order')</th>
                    <th class="wd-20p">@lang('global.name')</th>
                    <th class="wd-10p">@lang('global.email')</th>
