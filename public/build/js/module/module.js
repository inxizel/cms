...
$(document).ready(function () {
    ...
    $('#modules_table').DataTable({
        ...
        searching: true,
        columns: [{ data: 'DT_Row_Index', className: 'tx-center' }, { data: 'display_name' }, { data: 'module_category_name' }, { data: 'status', className: 'tx-center' }, { data: 'action', className: 'tx-center' }]
    });
});
//
// <script>
